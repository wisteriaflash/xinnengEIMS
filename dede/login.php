...
{
	$redmsg = '<div class="dfmsg">&nbsp;&nbsp;&nbsp;&nbsp;<font color=\'red\'><b>您的管理目录使用默认名称dede，建议在FTP里把它修改为其它名称，那样会更安全！</b></font></div>';
}
else
{
	$redmsg = '';
...
if($dopost=='login')
{
	...
	else
	{
		...
		if(!empty($userid) && !empty($pwd))
		{
			...
			{
				ShowMsg('你的用户名不存在!','login.php');
				exit();
			}
			else
			{
				ShowMsg('你的密码错误!','login.php');
				exit();
			}
		}
