...
else if($dopost=='save')
{
	...
	//保存到主表
	$query = "INSERT INTO `#@__archives`(id,typeid,sortrank,flag,ismake,channel,arcrank,click,title,color,writer,source,
	litpic,pubdate,senddate,mid,notpost,description,keywords,filename)
    VALUES ('$arcID','$typeid','$sortrank','$flag','$ismake','$channelid','$arcrank','0',
    '$title','$color','$writer','$source','$litpic','$pubdate','$senddate',
