...
if($arcrank!='')
{
	...
	$CheckUserSend = "<button type='button' class='btn1' onClick=\"location='content_sg_list.php?cid={$cid}&channelid={$channelid}&dopost=listArchives';\">所有文档</button>";
}
else
{
	$CheckUserSend = "<button type='button' class='btn1' onClick=\"location='content_sg_list.php?cid={$cid}&channelid={$channelid}&dopost=listArchives&arcrank=-1';\">稿件审核</button>";
}
