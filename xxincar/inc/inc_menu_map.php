...
{
	$menuMaps = array(1=>'常规操作', 2=>'内容管理', 3=>'系统插件', 4=>'HTML更新', 5=>'系统帮助');
	$mapLinks = array(1=>'index_body.php', 2=>'content_list.php', 3=>'plus_main.php', 4=>'makehtml_all.php', 5=>'http://www.dedeeims.com/help/');
	$mapNames = array(1=>'common', 2=>'content', 3=>'plugins', 4=>'updatehtml', 5=>'help');
}
else
{
	$menuMaps = array(1=>'常规操作', 2=>'内容管理', 3=>'系统插件', 4=>'HTML更新', 5=>'模板管理', 6=>'会员管理', 7=>'系统设置');
	$mapLinks = array(1=>'index_body.php', 2=>'content_list.php', 3=>'plus_main.php', 4=>'makehtml_all.php', 5=>'templets_main.php', 6=>'member_main.php', 7=>'sys_info.php');
	$mapNames = array(1=>'common', 2=>'content', 3=>'plugins', 4=>'updatehtml', 5=>'template', 6=>'member', 7=>'system');
}
...
<m:top mapitem='5' item='6_' name='系统帮助' display='none'>
