...
define('DEDETEMPDIR', DEDEROOT.'/templets');
...
if(!isset($userLang) || !file_exists(DEDEINC."/lang/{$userLang}.utf8.php"))
{
	require_once(DEDEINC."/lang/{$cfg_df_lang}.utf8.php");
}
else
{
	require_once(DEDEINC."/lang/{$userLang}.utf8.php");
}
...
$cfg_version = 'DedeEIMS_V1.1';
$cfg_soft_lang = 'utf-8';
$cfg_soft_public = 'eims';

$cfg_softname = '织梦企业信息管理系统';
$cfg_soft_enname = 'DedeEIMS';
$cfg_soft_devteam = '织梦官方团队';

//为了减少用户对栏目创建的理解难度，企业建站版把模板等相关选项进行了固化
$art_shortname = $cfg_df_ext = '.html';
$cfg_df_tempsgpage = "{style}/{lang}/catalog_sgpage.htm";
$cfg_df_tempindex = "{style}/{lang}/index_{nid}.htm";
$cfg_df_templist = "{style}/{lang}/list_{nid}.htm";
$cfg_df_temparticle = "{style}/{lang}/article_{nid}.htm";
$cfg_df_namerule = '{typedir}/{Y}/{M}{D}/{aid}'.$cfg_df_ext;
$cfg_df_namerule2 = '{typedir}/index-{tid}-{page}'.$cfg_df_ext;
...
if(file_exists(DEDEDATA."/cache/inc_catalog_lang.inc"))
{
	require_once(DEDEDATA."/cache/inc_catalog_lang.inc");
}

$cfg_indexurl = $cfg_mainsite;
$cfg_indexname = 'Home';
