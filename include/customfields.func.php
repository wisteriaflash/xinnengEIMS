...
function GetFormItem($ctag,$admintype='admin')
{
	...
	{
		$innertext = "<textarea name='$fieldname' id='$fieldname'  style='width:100%;height:80px' class='txt'></textarea>\r\n";
	}
	else if($fieldType=="datetime")
	{
		$nowtime = GetDateTimeMk(time());
		$innertext = "<input name=\"$fieldname\" value=\"$nowtime\"  type=\"text\" id=\"$fieldname\" style=\"width:250px\" class='txt'/>";
	}
	else if($fieldType=='img'||$fieldType=='imgfile')
	{
		$innertext = "<input type='text' name='$fieldname' id='$fieldname'  style='width:300px' class='txt'/> <input name='".$fieldname."_bt' type='button' class='np coolbg' value='浏览...' onClick=\"SelectImage('form1.$fieldname','big')\" />\r\n";
	}
	else if($fieldType=='media')
	{
		$innertext = "<input type='text' name='$fieldname' id='$fieldname'  style='width:300px' class='txt'/> <input name='".$fieldname."_bt' type='button' class='np coolbg' value='浏览...' onClick=\"SelectMedia('form1.$fieldname')\" />\r\n";
	}
	else if($fieldType=='addon')
	{
		$innertext = "<input type='text' name='$fieldname' id='$fieldname'  style='width:300px' class='txt'/> <input name='".$fieldname."_bt' type='button' class='np coolbg' value='浏览...' onClick=\"SelectSoft('form1.$fieldname')\" />\r\n";
	}
	else if($fieldType=='media')
	{
		$innertext = "<input type='text' name='$fieldname' id='$fieldname'  style='width:300px' class='txt'/> <input name='".$fieldname."_bt' type='button' class='np coolbg' value='浏览...' onClick=\"SelectMedia('form1.$fieldname')\" />\r\n";
	...
	else if($fieldType=='int'||$fieldType=='float')
	{
		...
		$innertext = "<input type='text' name='$fieldname' id='$fieldname'   style='width:100px' value='$dfvalue' class='txt'/> (填写数值)\r\n";
	}
	else
	{
		$dfvalue = ($ctag->GetAtt('default')!='' ? $ctag->GetAtt('default') : '');
		$innertext = "<input type='text' name='$fieldname' id='$fieldname'    style='width:250px' value='$dfvalue' class='txt'/>\r\n";
	}
	$formitem = str_replace("~name~",$ctag->GetAtt('itemname'),$formitem);
...
function GetFormItemValue($ctag,$fvalue,$admintype='admin')
{
	...
	{
		$innertext = "<textarea name='$fieldname' id='$fieldname'  style='width:100%;height:80px' class='txt'>$fvalue</textarea>\r\n";
	}
	...
	else if($ftype=="img")
	{
		...
		$innertext = "<input type='text' name='$fieldname' value='$fvalue'  id='$fieldname' style='width:300px' class='txt'/> <input name='".$fieldname."_bt' class='np coolbg' type='button' value='浏览...' onClick=\"SelectImage('form1.$fieldname','big')\" />\r\n";
	}
	...
	{
		$innertext = "<input type='text' name='$fieldname' value='$fvalue'  id='$fieldname' style='width:300px' /class='txt'> <input name='".$fieldname."_bt' class='np coolbg' type='button' value='浏览...' onClick=\"SelectMedia('form1.$fieldname')\" />\r\n";
	}
	else if($ftype=="addon")
	{
		$innertext = "<input type='text' name='$fieldname' id='$fieldname'  value='$fvalue' style='width:300px' class='txt'/> <input name='".$fieldname."_bt' class='np coolbg' type='button' value='浏览...' onClick=\"SelectSoft('form1.$fieldname')\" />\r\n";
	}
	else if($ftype=="int"||$ftype=="float")
	{
		$innertext = "<input type='text' name='$fieldname' id='$fieldname'  style='width:100px'  class='txt' value='$fvalue' /> (填写数值)\r\n";
	}
	else
	{
		$innertext = "<input type='text' name='$fieldname' id='$fieldname'  style='width:250px' value='$fvalue' class='txt'/>\r\n";
	}
	$formitem = str_replace('~name~',$ctag->GetAtt('itemname'),$formitem);
	$formitem = str_replace('~form~',$innertext,$formitem);
	return $formitem;
