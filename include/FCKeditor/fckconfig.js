...
FCKConfig.ToolbarSets["Small"] = [
	['Source','Preview','-','PasteText','PasteWord','-','Bold','Italic','Underline','StrikeThrough','-','OrderedList','UnorderedList'],
	['Link','Unlink','Anchor','-','TextColor','BGColor'],
	['Image','Flash','Media','Addon','-','Quote','Br','-','Rule','Codes','Table','Smiley']
] ;
