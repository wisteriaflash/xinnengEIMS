...
function lib_channelartlist(&$ctag,&$refObj)
{
	...
	$dsql->SetQuery("Select id,typename,typedir,isdefault,ispart,defaultname,namerule2  from `#@__arctype` where $tpsql order by sortrank asc limit $totalnum");
	$dsql->Execute();
